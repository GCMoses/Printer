...
public class ProductController : Controller
{
    ...
    public IActionResult Upsert(int? id)
    {
        ProductVM productVM = new()
        {
            ...
            DigiPixCoverList = _unitOfWork.DigiPixCover.GetAll().Select(i => new SelectListItem
            {
                Text = i.Name,
                Value = i.Id.ToString()
            }),
    ...
    {
        var productList = _unitOfWork.Product.GetAll(includeProperties: "Category,DigiPixCover");
